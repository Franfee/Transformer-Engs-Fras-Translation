...
def download_extract(name, folder=None):
    ...
    Defined in :numref:`sec_kaggle_house`"""
    BASE_DIR = sys.path[0]
    FILE_DIR = os.path.join(BASE_DIR, "../data", name)
    print("d2l check BASE:..........", BASE_DIR)
    print("d2l check FILE:..........", FILE_DIR)
    if not os.path.exists(FILE_DIR):
        FILE_DIR = os.path.join(BASE_DIR, "../../data", name)
        try:
            print("数据文件检查成功:", os.listdir(FILE_DIR))
            return FILE_DIR
